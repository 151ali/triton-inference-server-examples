...
inputs.append(grpcclient.InferInput("input.1",[1, 3, img_size, img_size ],"FP32"))
outputs.append(grpcclient.InferRequestedOutput("769"))
...
output = results.as_numpy("769")

o = non_max_suppression(output)
